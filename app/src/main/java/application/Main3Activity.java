...
public class Main3Activity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       //lv = (ListView) findViewById(R.id.list);
        ...
        Toast.makeText(Main3Activity.this, Nom_Station, Toast.LENGTH_SHORT).show();
    ...
    public class GetContacts extends AsyncTask<Void,Void,List<StationMetroGare>> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            Toast.makeText(Main3Activity.this, "Json Data is downloading", Toast.LENGTH_LONG).show();
        }
